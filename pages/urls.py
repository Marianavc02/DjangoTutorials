...
from .views import HomePageView, AboutPageView, ContactPageView, ImageViewFactory, ProductIndexView, ProductShowView, ProductCreateView, CartView, CartRemoveAllView, ImageViewNoDI
